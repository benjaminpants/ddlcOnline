...
label splashscreen:
    ...
    python:
        # This code handles destroying the network stuff, or it should, but it doesn't.
    ...
    if not persistent.first_run:
        ...
        "Moderation ingame is minimal, and Team Salvato nor the DDLC Online team are responsible nor encourage any actions done by players within."
