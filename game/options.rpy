...
define config.name = "DDLC Online"
...
#   Linux: $HOME/.renpy/
define config.save_directory = "DDLCOnline"
...
define config.layers = [ 'master', 'transient', 'ch_preview', 'screens', 'overlay', 'front' ]
